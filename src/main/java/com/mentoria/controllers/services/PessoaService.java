package com.mentoria.controllers.services;
...
public class PessoaService {
  ...
  public static void main(String[] args) throws Exception {
    ...
    PessoaService gerente = new PessoaService();
...
//    PessoaFisica.builder().cpf("001").nome("Fernanda").nome("Fernanda").nome("Fernanda").nome("Fernanda")
//        .nome("Fernanda").nome("Fernanda").build();
